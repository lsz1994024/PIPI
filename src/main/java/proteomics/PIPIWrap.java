        ...
        if (!expAaLists.isEmpty()) {
            ...
            if (!peptideSet.isEmpty()) {
                ...
                if (sqlResultSet.next()) {
                    ...
                    List<PepWithScore> candidatesList = search.candidatesList;
