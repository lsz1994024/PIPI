...
//    static final boolean nTermSpecific = true; //simulation test //todo
    ...
    public static final ArrayList<Integer> lszDebugScanNum = new ArrayList<>(Arrays.asList(12557));//62940,62866,72612, 72611
...
//        System.out.println("time," + (t4-t3) + "," + (t3-t2)+ "," + (t2-t1));
        ...
        for (String scanName : validScanSet) {
            ...
            taskListBone.add(threadPoolBone.submit(new PreSearch(Integer.valueOf(scanNameStr[2]), buildIndex, massTool, ms2Tolerance, ms1Tolerance, leftInverseMs1Tolerance, rightInverseMs1Tolerance
                    ...
                    , spectraParserArray[Integer.valueOf(scanNameStr[0])], minClear, maxClear, lockBone, scanName, precursorCharge, precursorMass, specProcessor, inferPTM ,pepTruth.get(1886))));
        }
