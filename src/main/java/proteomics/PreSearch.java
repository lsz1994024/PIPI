...
//tagQueue.
            ...
            String protToCheck = "sp|Q9H8M5|CNNM2_HUMAN";
            if (top1Pep.containsKey(protToCheck)){
//                System.out.println(scanNum + "," + top1Pep.get(protToCheck) );
//
//                for (String tag : protTagMap.get(protToCheck)) {
